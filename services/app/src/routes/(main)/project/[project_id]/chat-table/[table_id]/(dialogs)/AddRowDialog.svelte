...
<Dialog.Root bind:open={isAddingRow}>
	<Dialog.Content class="min-w-[35rem]">
		<Dialog.Header>New row</Dialog.Header>

		<form on:submit|preventDefault={handleAddRow}>
			...
			<Dialog.Actions>
				<div class="flex gap-2">
					...
					<Button type="submit" loading={isLoadingAddRow} class="relative grow px-6 rounded-full">
						Add
					</Button>
				</div>
			</Dialog.Actions>
